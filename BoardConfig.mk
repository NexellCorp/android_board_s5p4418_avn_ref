TARGET_BOARD_INFO_FILE := device/nexell/s5p4418_avn_ref/board-info.txt


TARGET_BOARD_PLATFORM 		 := slsiap
TARGET_BOOTLOADER_BOARD_NAME := s5p4418_avn_ref
...
# opengl
BOARD_EGL_CFG := device/nexell/s5p4418_avn_ref/egl.cfg
...
# sepolicy
#BOARD_SEPOLICY_DIRS := \
	device/nexell/s5p4418_avn_ref/sepolicy
...
BOARD_ROOTIMAGE_PARTITION_SIZE := 6959398912
