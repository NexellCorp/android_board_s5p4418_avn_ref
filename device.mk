...
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_avn_ref/init.s5p4418_avn_ref.rc:root/init.s5p4418_avn_ref.rc \
	device/nexell/s5p4418_avn_ref/init.s5p4418_avn_ref.usb.rc:root/init.s5p4418_avn_ref.usb.rc \
	device/nexell/s5p4418_avn_ref/init.recovery.s5p4418_avn_ref.rc:root/init.recovery.s5p4418_avn_ref.rc \
	device/nexell/s5p4418_avn_ref/fstab.s5p4418_avn_ref:root/fstab.s5p4418_avn_ref \
	device/nexell/s5p4418_avn_ref/ueventd.s5p4418_avn_ref.rc:root/ueventd.s5p4418_avn_ref.rc \
	device/nexell/s5p4418_avn_ref/adj_lowmem.sh:root/adj_lowmem.sh \
	device/nexell/s5p4418_avn_ref/start_deferred.sh:root/start_deferred.sh \
...
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_avn_ref/keypad_s5p4418_avn_ref.kl:system/usr/keylayout/keypad_s5p4418_avn_ref.kl \
	device/nexell/s5p4418_avn_ref/keypad_s5p4418_avn_ref.kcm:system/usr/keychars/keypad_s5p4418_avn_ref.kcm

################################################################################
# touch
################################################################################
PRODUCT_COPY_FILES += \
    device/nexell/s5p4418_avn_ref/tsc2007.idc:system/usr/idc/tsc2007.idc 
...
################################################################################
#PRODUCT_COPY_FILES += \
	#device/nexell/s5p4418_avn_ref/vold.fstab:system/etc/vold.fstab
...
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_avn_ref/media_codecs.xml:system/etc/media_codecs.xml \
	device/nexell/s5p4418_avn_ref/media_profiles.xml:system/etc/media_profiles.xml
...
# zeroboot
#PRODUCT_COPY_FILES += \
	hardware/samsung_slsi/slsiap/prebuilt/modules/drv_storage.ko:system/lib/modules/drv_storage.ko \
	hardware/samsung_slsi/slsiap/prebuilt/modules/drv_zero_snapshot.ko:system/lib/modules/drv_zero_snapshot.ko \
	hardware/samsung_slsi/slsiap/prebuilt/modules/nalcode.bin:system/lib/modules/nalcode.bin
...
PRODUCT_COPY_FILES += \
    hardware/samsung_slsi/slsiap/prebuilt/avn_monitor/nx_avn_monitor:system/bin/nx_avn_monitor \
	    hardware/samsung_slsi/slsiap/prebuilt/iap_test/iap_test:system/bin/iap_tes
################################################################################
...
#PRODUCT_COPY_FILES += \
#	device/nexell/s5p4418_avn_ref/gps/u-blox/u-blox.conf:system/etc/u-blox.conf
...
################################################################################
#PRODUCT_COPY_FILES += \
  #device/nexell/s5p4418_avn_ref/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml \
...
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_avn_ref/busybox-armv7l:system/bin/busybox-armv7l \
	device/nexell/s5p4418_avn_ref/memtester1-1:system/bin/memtester1-1 \
	device/nexell/s5p4418_avn_ref/hwreg_cmd:system/bin/hwreg_cmd
...
DEVICE_PACKAGE_OVERLAYS := \
	device/nexell/s5p4418_avn_ref/overlay
...
# $(call inherit-product-if-exists, device/nexell/s5p4418_avn_ref/tiny_gapps.mk)
